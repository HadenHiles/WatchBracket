...
ENV GAME_API_INTERNAL_URL=$GAME_API_INTERNAL_URL NEXT_PUBLIC_ENABLE_PRESENTATION_TEST_MODE=$NEXT_PUBLIC_ENABLE_PRESENTATION_TEST_MODE NEXT_TELEMETRY_DISABLED=1
