...
ENV GAME_API_INTERNAL_URL=$GAME_API_INTERNAL_URL PUBLIC_APP_URL=$PUBLIC_APP_URL NEXT_PUBLIC_ENABLE_PRESENTATION_TEST_MODE=$NEXT_PUBLIC_ENABLE_PRESENTATION_TEST_MODE CAST_RECEIVER_APP_ID=$CAST_RECEIVER_APP_ID NEXT_TELEMETRY_DISABLED=1
